...
- `service-biz-new`：业务控制面
- `service-ui-new`：客户 Web Console
- `server-main-new`：运营管理控制台
- `server-wire`：联网控制面
...
- [service-biz-new README](../server/service-biz-new/README.md)
- [service-ui-new](../server/service-ui-new)
- [server-main-new](../server/server-main-new)
...
- 原有 `server-biz`、`service-ui-old`、`server-main-old` 已删除，新入口统一使用 `service-biz-new`、`service-ui-new`、`server-main-new`
