...
BROKER_SERVICES="${BROKER_SERVICES:-emqx}"
POST_BROKER_STABILIZATION_SECONDS="${POST_BROKER_STABILIZATION_SECONDS:-15}"
PRESERVE_ENV_KEYS="${PRESERVE_ENV_KEYS:-POSTGRES_PASSWORD SLAN_RELAY_TICKET_SECRET SLAN_INTERNAL_WIRE_TOKEN SLAN_WIRE_TICKET_SECRET SLAN_WIRE_TICKET_SECRETS SLAN_MQTT_PASSWORD_SECRET SLAN_MQTT_WEBHOOK_TOKEN SLAN_NODE_SSH_CREDENTIAL_KEY}"
