...
export SLAN_TEST_EMAIL="${SLAN_TEST_EMAIL:-ios-dual-flutter-1782695112673492000@example.test}"
export SLAN_TEST_PASSWORD="${SLAN_TEST_PASSWORD:-Password123!}"
...
log "ios stable defaults: account=${SLAN_TEST_EMAIL}"
