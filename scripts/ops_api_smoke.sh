...
OPS_BASE_URL="${SLAN_OPS_BASE_URL:-http://127.0.0.1:${PORT}}"
...
curl --silent --fail "${WEB_BASE_URL}/api/client-downloads" >/dev/null || fail "client downloads public list failed"
