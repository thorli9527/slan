...
SLAN_LINUX_DEFAULT_CONTROL_BASE_URL="${SLAN_CONTROL_BASE_URL:-http://47.245.40.231:28080}"
SLAN_LINUX_DEFAULT_SERVICE_HOST="${SLAN_CLIENT_CORE_SERVICE_HOST:-127.0.0.1:46392}"
SLAN_LINUX_DEFAULT_TUN_NAME="${SLAN_LINUX_TUN_NAME:-slan0}"
...
SLAN_LINUX_SERVICE_UNIT_PATH="/lib/systemd/system/$SLAN_LINUX_SERVICE_NAME"
...
SLAN_LINUX_TUN_NAME=$SLAN_LINUX_DEFAULT_TUN_NAME
EOF
}
