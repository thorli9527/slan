...
- iOS: add a Runner iOS target, Network Extension target, app group storage for queued control tasks, and a durable bridge provider behind `SLANAppCoreServiceHost`.
