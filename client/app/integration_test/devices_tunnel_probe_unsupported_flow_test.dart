...
void main() {
  ...
  testWidgets('devices page surfaces probe unsupported failures',
      (tester) async {
    host.failProbe = true;
    host.probeFailureCode = 'probe_unsupported_path';
    host.probeFailureMessage = 'active path does not support probe';
    ...
    page.expectProbeFailure(
      kind: 'unsupported',
      detail: 'active path does not support probe',
    );
  });
}
