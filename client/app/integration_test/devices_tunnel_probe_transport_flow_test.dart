...
void main() {
  ...
  testWidgets('devices page surfaces probe transport failures', (tester) async {
    host.failProbe = true;
    host.probeFailureCode = 'probe_transport_error';
    host.probeFailureMessage = 'relay socket read failed';
    ...
    page.expectProbeFailure(
      kind: 'transport',
      detail: 'relay socket read failed',
    );
  });
}
