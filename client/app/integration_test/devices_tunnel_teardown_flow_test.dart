...
void main() {
  ...
  testWidgets('devices page drives tunnel down and remove peer actions',
      (tester) async {
    ...
    page.expectTunnelRuntimeCleared();
    host.expectTunnelLifecycleWithTeardown();
  });
}
