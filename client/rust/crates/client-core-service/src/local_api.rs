...
impl LocalServiceMethod {
    pub(crate) fn parse(method: &str) -> Self {
        match method {
            ...
            "localServerApiSettings" => Self::LocalServerApiSettings,
            "localUpdateServerApiSettings" => Self::LocalUpdateServerApiSettings,
            ...
            "localConnectivityChanged" => Self::LocalConnectivityChanged,
            ...
            "localActivateDevice" => Self::LocalActivateDevice,
    ...
    pub(crate) fn should_notify(self) -> bool {
        matches!(
            ...
            Self::Start
                ...
                | Self::LocalUpdateServerApiSettings
        )
    }
...
#[derive(Debug, Deserialize)]
pub(crate) struct ActivateDeviceRequest {
