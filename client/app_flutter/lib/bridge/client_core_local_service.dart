...
class ClientCoreLocalService {
  ...
  static const _definedServiceHost = String.fromEnvironment(
  ...
  Future<Map<String, Object?>?> localStateWatch({
    ...
    return requestJson(
      'localStateWatch',
      arguments: {'lastRevision': lastRevision, 'timeoutMs': timeoutMs},
  ...
  /// 查询桌面后台服务当前使用的控制面 API 地址。
  Future<Map<String, Object?>?> localServerApiSettings() async {
    return requestJson('localServerApiSettings');
  }

  /// 更新并持久化桌面后台服务的控制面 API 地址。
  Future<Map<String, Object?>?> localUpdateServerApiSettings(
    String serverApiBaseUrl,
  ) async {
    return requestJson(
      'localUpdateServerApiSettings',
      arguments: {'serverApiBaseUrl': serverApiBaseUrl},
    );
  }
  ...
  /// 获取待发布到 MQTT 的上行控制消息。
  Future<Map<String, Object?>?> localControlOutbox({Object? arguments}) async {
  ...
  Future<Map<String, Object?>?> localMarkControlAcked({
    ...
    return requestJson('localMarkControlAcked', arguments: {'taskId': taskId});
  }
  ...
  Future<Map<String, Object?>?> localActivateDevice(String key) {
    return requestJson('localActivateDevice', arguments: {'key': key});
  }
  ...
  Future<Object?> request(
    ...
    final requestArguments = _argumentsWithRequestId(
      arguments,
      effectiveRequestId,
    );
    ...
    try {
      final payload = jsonEncode({'method': method, 'args': requestArguments});
