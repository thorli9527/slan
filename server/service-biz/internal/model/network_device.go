...
type NetworkMembershipSource string
...
const (
	NetworkMembershipSourceDirect      NetworkMembershipSource = "direct"
	NetworkMembershipSourceDeviceGroup NetworkMembershipSource = "device_group"
	NetworkMembershipSourceExcluded    NetworkMembershipSource = "excluded"
)
...
type NetworkDevice struct {
	...
	MembershipSource   NetworkMembershipSource `json:"membershipSource,omitempty"`
