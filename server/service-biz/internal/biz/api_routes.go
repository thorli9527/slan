...
func (s *Server) registerExternalAPIRoutes(mux *http.ServeMux) {
	registerAPIRoutes(mux, []apiRoute{
		...
		route(http.MethodGet, "/api/users/{userId}/device-groups", s.listDeviceGroups),
		route(http.MethodPost, "/api/users/{userId}/device-groups", s.createDeviceGroup),
		route(http.MethodPatch, "/api/users/{userId}/device-groups/{groupId}", s.updateDeviceGroup),
		route(http.MethodDelete, "/api/users/{userId}/device-groups/{groupId}", s.deleteDeviceGroup),
		route(http.MethodPut, "/api/users/{userId}/devices/{deviceId}/groups", s.setDeviceGroups),
		...
		route(http.MethodPatch, "/api/networks/{networkId}/security-groups/{securityGroupId}", s.updateSecurityGroup),
