export const WEB_API = {
  ...
  networkDeviceGroup: (networkId: string, groupId: string, actorUserId = '') => `/api/web/networks/${encodeURIComponent(networkId)}/device-groups/${encodeURIComponent(groupId)}${actorUserId ? `?actorUserId=${encodeURIComponent(actorUserId)}` : ''}`,
