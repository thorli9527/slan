...
export const INITIAL_WORKSPACES: WorkspaceRow[] = [
  { networkId: DEFAULT_NETWORK_ID, workspaceId: DEFAULT_NETWORK_ID, name: '默认网络', intraGroupPolicy: 'allow', default: true, members: 1, devices: 2, zone: `default.${DEFAULT_NETWORK_ID}.${DEFAULT_USER_ID}.sub.staticlss.com` },
  { networkId: DEV_NETWORK_ID, workspaceId: DEV_NETWORK_ID, name: '开发组', intraGroupPolicy: 'allow', default: false, members: 2, devices: 1, zone: `dev.${DEV_NETWORK_ID}.${DEFAULT_USER_ID}.sub.staticlss.com` },
];
...
export const INITIAL_DNS_ZONES: DNSZoneRow[] = [
  { zoneId: DEFAULT_ZONE_ID, networkId: DEFAULT_NETWORK_ID, workspaceId: DEFAULT_NETWORK_ID, zone: 'default.lan', recordType: 'A', value: '10.0.0.1', status: 'active' },
  { zoneId: DEV_ZONE_ID, networkId: DEV_NETWORK_ID, workspaceId: DEV_NETWORK_ID, zone: 'dev.internal', recordType: 'A', value: '10.0.0.2', status: 'active' },
];

export const INITIAL_DNS_RECORDS: DNSRow[] = [
  { recordId: DEFAULT_RECORD_ID, zoneId: DEFAULT_ZONE_ID, networkId: DEFAULT_NETWORK_ID, workspaceId: DEFAULT_NETWORK_ID, name: 'mac', fqdn: 'mac.default.lan', recordType: 'A', value: 'alice@staticlss.com / 办公 Mac', deviceId: DEFAULT_MAC_DEVICE_ID, ttl: 60, targetType: 'device' },
  { recordId: DEV_RECORD_ID, zoneId: DEV_ZONE_ID, networkId: DEV_NETWORK_ID, workspaceId: DEV_NETWORK_ID, name: 'api', fqdn: 'api.dev.internal', recordType: 'A', value: 'alice@staticlss.com / Alice iPhone', deviceId: DEFAULT_IPHONE_DEVICE_ID, ttl: 60, targetType: 'device' },
];
