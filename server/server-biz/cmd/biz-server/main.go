...
func main() {
	...
	authService, deviceService, networkService, nodeService, bootstrapService, tokenVerifier, controlChannel, controlSync, messageDelivery, iceService, wireService, opsService := impl.NewDBServices(cfg, runtime)
