...
type OpsNetworkQualityItem struct {
	...
	PolicyTemplateName string `json:"policyTemplateName,omitempty"`
...
type RelayPolicyTemplate struct {
	...
	RelayMtu            uint32 `json:"relayMtu"`
	MaxFramePayload     uint32 `json:"maxFramePayload"`
	RecommendationLevel uint8  `json:"recommendationLevel"`
	ExecutionLevel      uint8  `json:"executionLevel"`
...
type RelayPolicyTemplateRequest struct {
	Name                string `json:"name"`
	Description         string `json:"description,omitempty"`
	PathType            string `json:"pathType,omitempty"`
	PathStrategy        string `json:"pathStrategy"`
