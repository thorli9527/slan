...
type DeviceNetworkStateRequest struct {
	...
	RelayPolicyID          string `json:"relayPolicyId,omitempty"`
	RelayPolicyScope       string `json:"relayPolicyScope,omitempty"`
	RelayPolicyApplied     bool   `json:"relayPolicyApplied,omitempty"`
	RelayPolicyUpdatedAtMs uint64 `json:"relayPolicyUpdatedAtMs,omitempty"`
	RelayPolicyAppliedAtMs uint64 `json:"relayPolicyAppliedAtMs,omitempty"`
	RelayMtu               uint32 `json:"relayMtu,omitempty"`
	MaxFramePayload        uint32 `json:"maxFramePayload,omitempty"`
	RelayPolicyReason      string `json:"relayPolicyReason,omitempty"`
}
