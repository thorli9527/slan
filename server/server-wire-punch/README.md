...
It is intentionally separate from `service-biz`: biz owns device identity, network resources, ACLs, authorization keys, and durable state; punch owns temporary endpoint/session state used to coordinate direct UDP probing.
