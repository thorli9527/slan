...
export class AppComponent implements OnInit {
  ...
  products: Product[] = [
    ...
    { productId: 'prod-pro-month', name: '专业版月付', type: 'plan', planCode: 'pro', period: 'monthly', validDays: 31, relayTrafficGb: 1024, relayBandwidthMbps: 100, listPrice: 39, salePrice: 39, currency: 'CNY', autoRenew: true, status: 'active', description: '适合个人和小团队，支持自定义域名和安全组' },
